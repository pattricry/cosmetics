...
class ShippingAdmin(admin.ModelAdmin):
    list_display = ['user','first_name','last_name','email','phone','order_address', 'billing_address','state','city']
    readonly_fields = ['user','first_name','last_name','email','phone','order_address', 'billing_address','state','city']